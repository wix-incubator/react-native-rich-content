...
const computeAndroidBlurRadiusForResolution = (resolution) => ((5 / 654120) * resolution) + 19.05;
const computeIOSBlurRadiusForResolution = (resolution) => ((30 / 383916) * resolution) + 18.28;
...
export const computeBlurForSize = (size) => {
  if (size) {
